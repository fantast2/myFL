...
if __name__ == "__main__":
    ...
    config = {
        ...
        "cmapss_subset": getattr(args, "cmapss_subset", "fd001"),
        "window_size": getattr(args, "window_size", 30),
        "stride": getattr(args, "stride", 1),
        "pred_horizon": getattr(args, "pred_horizon", 1),
        "normalization_method": getattr(args, "normalization_method", "standard"),
        "rul_cap": getattr(args, "rul_cap", 130),
        "cmapss_data_dir": getattr(args, "cmapss_data_dir", None),
    }
